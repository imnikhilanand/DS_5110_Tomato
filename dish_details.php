...
<tr><th><p style="font-size: 40px; color: red"><?php echo $dish_name;?></p></th></tr>


<?php

// Fetching the data of dishes using the na,e
$sql_2 = "SELECT * from dish_details dd WHERE dd.dish_name = '".$dish_name."'";
$result_2 = $conn->query($sql_2);
if ($result_2->num_rows > 0) {
  while($row = $result_2->fetch_assoc()) {
?>
<tr>
    <th class="restaurant_name"><?php echo $row["restaurant_name"]. " • ". $row["restaurant_address"]. " • $" .$row["price"]?></th>
</tr>
...
// javascipt function to add items into the cart
